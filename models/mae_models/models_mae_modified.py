...
# --------------------------------------------------------
# Very slightly modified version such that the Encoder accepts a further token without positional encoding 
# Source: https://github.com/wangsr126/MAE-Lite.git
...
from models.mae_models.models_vit import Block

from models.mae_models.pos_embed import get_2d_sincos_pos_embed
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward_encoder(self, x, mask_ratio, y,ids_shuffle=None):
        # embed patches
    ...
    def forward(self, imgs,y, mask_ratio=0.75, ids_shuffle=None):#this won't work anymore.
        latent, mask, ids_restore, ids_shuffle = self.forward_encoder(imgs, mask_ratio,y, ids_shuffle)

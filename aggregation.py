...
def aggregation():
    ...
    if modality in ["Porpoise","PrePorpoise","PrePorpoise_meanagg_attmil","PrePorpoise_meanagg"]:
        _,risk_all,c_all,l_con_all,risk_group = MM_Trainer_sweep(run,model,optimizer,criterion,training_dataloader,
        ...
        _,risk_all,c_all,l_con_all,risk_group = Uni_Trainer_sweep(run,model,optimizer,criterion,training_dataloader,
                    val_dataloader,bins,epochs,device,storepath,run_name,
                    l1_lambda,modality=modality,testloader=test_dataloader
                    )
